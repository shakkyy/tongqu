...
% --- 痛点洞察：01 / 02 / 03 大号数字版式，无卡片 ---
\begin{frame}[t]{痛点洞察}
    \vspace{0.2cm}
    \footnotesize

    \noindent\begin{tabular}{@{}p{1.0cm}@{\hspace{0.3em}}p{11.2cm}@{}}
      \bignum{01} & \textbf{\normalsize\color{darkred}儿童侧}\;\textcolor{gray!70}{—}\;\textbf{想象力强，工具门槛高} \\[1pt]
      & 孩子天生\kw{想象力丰富}，却缺少低门槛的表达工具——不会打字、不熟流程，更不会 Prompt。 \\[0.55em]
      \bignum{02} & \textbf{\normalsize\color{darkred}家长侧}\;\textcolor{gray!70}{—}\;\textbf{优质内容筛选成本高} \\[1pt]
      & 家长希望孩子接触\kw{优质内容}，要么筛选成本高，要么参与感低，难以形成陪伴式使用。 \\[0.55em]
      \bignum{03} & \textbf{\normalsize\color{darkred}文化侧}\;\textcolor{gray!70}{—}\;\textbf{共创入口缺失} \\[1pt]
